...
class RecommendationRequestFilterByReceiverTest {
    private final RecommendationRequestFilter requestFilter = new RecommendationRequestFilterByReceiver();
    ...
    void whenRequestFilterDtoIsApplicableThenReturnTrue() {
        User firstReceiver = new User();
        firstReceiver.setId(1L);
        filterDto.setReceiverId(firstRequest.getReceiver().getId());
